...
//自己追加的方法
zss_editor.insertImageLink = function(url,alt,linkUrl,style) {
    zss_editor.restorerange();
    var imgHtml = '<img src="'+url+'" alt="'+alt+'" style="'+style+'" />';
    //target="_blank" 会在新窗口中打开
    let target = 'target="_blank"';
    var html = '<a href="'+linkUrl+'" '+target+'>'+ imgHtml +'</a>';
    zss_editor.insertHTML(html);
    zss_editor.enabledEditingItems();
}
//end
