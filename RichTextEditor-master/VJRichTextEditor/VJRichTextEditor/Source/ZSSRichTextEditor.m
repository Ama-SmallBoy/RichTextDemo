...
- (void)insertImage:(NSString *)url alt:(NSString *)alt {
    ...
    [self.editorView evaluateJavaScript:trigger completionHandler:^(id _Nullable reponse, NSError * _Nullable error) {
        NSLog(@"====%@",error.description);
    }];
}


- (void)insertImageLink:(NSString *)url alt:(NSString *)alt linkUrl:(NSString *)linkUrl style:(NSString *)style {
    NSString *trigger = [NSString stringWithFormat:@"zss_editor.insertImageLink(\"%@\", \"%@\",\"%@\", \"%@\");", url, alt,linkUrl,style];
    [self.editorView evaluateJavaScript:trigger completionHandler:^(id _Nullable reponse, NSError * _Nullable error) {
        NSLog(@"====%@",error.description);
    }];
}
...
//        
//    }];
    NSString * urlStr  = @"https://goss.veer.com/creative/vcg/veer/800water/veer-132047609.jpg";
    [self insertImage:urlStr alt:@"https://goss.veer.com/creative/vcg/veer/800water/veer-132047609.jpg"];
    [self.navigationController dismissViewControllerAnimated:YES completion:nil];
}
